        ...
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:gap-8 items-center">
          ...
          <div className="w-full">
            ...
            <h1 className="reveal mt-6 sm:mt-8 font-display text-[2.75rem] sm:text-[4rem] md:text-[5rem] lg:text-[7rem] xl:text-[8rem] leading-[0.92] tracking-tight uppercase text-white">
              <span className="block">AI Visuals</span>
              <span className="block">
                + <span className="italic-serif">Content</span>
              </span>
              <span className="block">
                For <span className="bg-[#E05A2B] text-white px-2 sm:px-3 -mx-1 inline border-none -rotate-1">Modern</span>{" "}
                Brands.
              </span>
            </h1>

            <p className="reveal mt-6 sm:mt-8 text-sm sm:text-base text-[#999] leading-relaxed font-sans">
              Campaign direction, AI-generated visuals, and content systems built for brands that need to produce more — without the traditional cost of production.
            </p>
